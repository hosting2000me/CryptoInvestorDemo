...
def main():
    ...
    # Note: benchmark_metrics_result.json is generated by calculate_benchmark.py
    # which calculates metrics from quotes.csv filtered from the first output date
    print("\nNote: benchmark_metrics_result.json should be generated using calculate_benchmark.py")
